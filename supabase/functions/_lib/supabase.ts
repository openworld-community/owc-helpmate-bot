...
const { DEBUG, APP_NAME, SUPABASE_URL, SUPABASE_DB_URI, SUPABASE_ANON_KEY, SUPABASE_SERVICE_ROLE_KEY, BOT_SESSIONS_TABLE } = ENV;
...
export const supabaseCreateStorage = (table: string = BOT_SESSIONS_TABLE) => {
